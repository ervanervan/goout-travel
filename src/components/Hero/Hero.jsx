...
export default function Hero() {
  return (
    <section className="relative container mx-auto md:px-7 pb-[3.75rem]">
      <div className="bg-bgGray rounded-3xl flex flex-col md:flex-row justify-between">
        <div className="px-7 md:px-10 xl:px-[3.75rem] pt-8 md:pt-8 lg:pt-16 xl:pt-24 flex-1">
          ...
          <p className="text-textSecondary text-sm leading-6 xl:text-base xl:leading-8 lg:w-4/5 2xl:w-3/5">
